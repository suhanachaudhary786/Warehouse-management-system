    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (res.data.user.role !== "manager") {
                toast.error("Access denied! This is Manager Portal. Please use manager credentials.");
                setLoading(false);
                return;
            }
        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4">
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl font-bold text-white mb-2">Manager Portal</h1>
                ...
                <div className="bg-white/10 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8">
                    ...
                    <div className="mt-6 text-center">
                        <a href="/worker-login" className="text-sm text-amber-500 hover:text-amber-400 transition">
                            Worker Portal? Click here →
                        </a>
                    </div>
